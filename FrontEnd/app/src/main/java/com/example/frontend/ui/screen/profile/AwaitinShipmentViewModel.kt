...
@HiltViewModel
class AwaitingShipmentViewModel @Inject constructor(
    ...
    init{
        getAllSubmittedOrderOfUsers()
    }
    fun getAllSubmittedOrderOfUsers(){
        viewModelScope.launch{
            val result = orderRepo.getAllSubmittedOrdersOfUser(authManager.getUserNameOnce().toString())
            when(result){
