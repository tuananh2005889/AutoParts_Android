...
@HiltViewModel
class AwaitingComfirmationViewModel @Inject constructor(
    ...
    init{
        getAllPaidOrdersOfUsers()
    }
    fun getAllPaidOrdersOfUsers(){
        viewModelScope.launch{
           val result = orderRepo.getAllPaidOrdersOfUser(authManager.getUserNameOnce().toString())
            when(result){
